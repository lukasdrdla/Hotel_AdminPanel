        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_InsuranceCompany_InsuranceCompanyId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Snídaně", 150.00m },
                    { 2, "Polopenze", 350.00m },
                    { 3, "Plná penze", 500.00m },
                    { 4, "All-Inclusive", 750.00m },
                    { 5, "Večeře pouze", 200.00m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Standardní jednolůžkový" },
                    { 2, "Standardní dvojlůžkový" },
                    { 3, "Luxusní apartmán s vířivkou" },
                    { 4, "Rodinný pokoj s kuchyňkou" },
                    { 5, "Business pokoj" },
                    { 6, "Pokoj pro hosty se zvířaty" },
                    { 7, "Ekonomický pokoj" },
                    { 8, "Penthouse" },
                    { 9, "Pokoj s výhledem na moře" },
                    { 10, "Pokoj s terasou" }
                });
