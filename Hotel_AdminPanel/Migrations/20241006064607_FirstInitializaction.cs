...
{
    /// <inheritdoc />
    public partial class FirstInitializaction : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "", "", 2, 0, 1200m, "A101", 1, 1 },
                    { 2, "", "", 2, 1, 2000m, "A102", 1, 2 },
                    { 3, "", "", 4, 2, 4200m, "A103", 1, 3 },
                    { 4, "", "", 2, 2, 3250m, "A104", 1, 4 },
                    { 5, "", "", 2, 1, 2300m, "A105", 1, 5 },
                    { 6, "", "", 2, 0, 5350m, "A106", 1, 6 }
                });
